...
const httpServer = http.createServer((req, res) => {
  ...
  let filePath;
  if (req.url === '/' || req.url === '/index.html') filePath = path.join(__dirname, 'public/index.html');
  else if (req.url === '/blue') filePath = path.join(__dirname, 'public/blue.html');
  else if (req.url === '/red')  filePath = path.join(__dirname, 'public/red.html');
  else filePath = path.join(__dirname, 'public', req.url);
